...
| **DUST** | Secondary token earned from staking registered UTXOs. Accumulates passively once UTXOs are registered for dust generation. |
| **Specks** | Smallest indivisible unit of both tokens. 1 NIGHT = 10⁶ specks. 1 DUST = 10¹⁵ specks. All SDK and ledger values are expressed in specks. |
